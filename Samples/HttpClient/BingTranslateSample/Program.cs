   ...
   class Program
   {
      ...
      static async void RunClient()
      {
         try
         {
            ...
            var client = new HttpClient(new AccessTokenMessageHandler(new HttpClientHandler()));
            ...
            var options = new TranslateOptions("", "defaultUser");
            ...
            var response = await client.PostAsync<TranslateOptions>(_address, options, xmlFormatter);
            ...
            var translation = await response.Content.ReadAsAsync<GetTranslationsResponse>(new[] { xmlFormatter });
